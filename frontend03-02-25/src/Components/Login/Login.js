    ...
    const fetchAuthUrls = async () => {
      try {
        const { data: googleResponse } = await axios.get(
          "http://localhost:5000/api/auth/auth/google"
        );
        const { data: facebookResponse } = await axios.get(
          "http://localhost:5000/api/auth/auth/facebook"
        );
        const { data: appleResponse } = await axios.get(
          "http://localhost:5000/api/auth/auth/apple"
        );
